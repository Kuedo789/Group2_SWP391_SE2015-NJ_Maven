    ...
    <div class="container-fluid bg-dark bg-img p-5 mb-5">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <a href="user-list" class="text-primary font-weight-bold">← Back to List</a>
            </div>
        </div>
    </div>
                    ...
                    <form action="userdetail" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="text" name="phone" value="${USER_DATA.phone}" required class="form-control bg-light border-0 px-4" placeholder="Nhập số điện thoại..." style="height: 55px;">
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <select name="roleId" class="form-select bg-light border-0 px-4" style="height: 55px; width: 100%;">
                                    <option value="ADMIN" ${USER_DATA.roleId == 'ADMIN' ? 'selected' : ''}>Administrator</option>
                                    <option value="STAFF" ${USER_DATA.roleId == 'STAFF' ? 'selected' : ''}>Bakery Kitchen Staff</option>
                                    <option value="SHIPPER" ${USER_DATA.roleId == 'SHIPPER' ? 'selected' : ''}>Deliverier</option>
                                    <option value="CUSTOMER" ${USER_DATA.roleId == 'CUSTOMER' ? 'selected' : ''}>Customer</option>
                                </select>
                            </div>
                            
                            <div class="col-sm-12 mt-4">
                                <button class="btn btn-primary border-inner w-100 py-3 text-uppercase font-weight-bold" type="submit">Lưu thông tin tài khoản</button>
                            </div>
                        </div>
                    </form>
                </div>
