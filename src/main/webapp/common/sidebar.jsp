                                    ...
                                    List<ScreenPermission> screens = pDAO.getScreensWithStatus(currentUser.getRoleId());
                                        ...
                                        <div class="sidebar">
                                            ...
                                            <ul class="sidebar-menu">
                                                ...
                                                <c:if
                                                    test="${sessionScope.user.roleId eq 'ADMIN' || requestScope.LIVE_PERMISSIONS.contains('/admin/staff?action=list')}">
                                                    <li
                                                        class="menu-item ${param.activeMenu == 'users' ? 'active' : ''}">
                                                        <a
                                                            href="${pageContext.request.contextPath}/admin/staff?action=list"><i
                                                                class="fa-solid fa-user-gear"></i> Tài khoản</a>
                                                    </li>
                                                </c:if>
