        ...
        <section class="section">
            <div class="designer-card">
                <div class="designer-content">
                    ...
                    <p>
                        Thể hiện tình cảm qua từng lớp bánh. Chọn hương vị, màu sắc
                        và lời nhắn để tạo nên món quà độc nhất vô nhị.
                    </p>

                    <div class="step-grid">
                        <div class="step-box"><span>1</span> Chọn cốt bánh</div>
                        <div class="step-box"><span>2</span> Chọn lớp kem</div>
                        <div class="step-box"><span>3</span> Thêm topping</div>
                        <div class="step-box"><span>4</span> Viết lời nhắn</div>
                    </div>

                    <a href="#" class="btn btn-primary">Bắt đầu thiết kế</a>
                </div>

                <div class="designer-preview">
                    <img class="designer-cake-img"
                         src="${pageContext.request.contextPath}/assets/images/designer/custom.png"
                         alt="Tự thiết kế bánh">

                    <span class="chip chip-1">● Matcha</span>
                    <span class="chip chip-2">● Kem dâu</span>
                    <span class="chip chip-3">♡ Dâu tươi</span>
                    <span class="chip chip-4">✎ Lời nhắn riêng</span>

                    <div class="price-chip">
                        Giá tạm tính từ: <strong>350.000đ</strong>
                    </div>
                </div>
            </div>
        </section>
