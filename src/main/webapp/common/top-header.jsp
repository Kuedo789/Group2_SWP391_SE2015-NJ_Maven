...
<div class="top-header">
    ...
    <div class="header-right">
        ...
        <div class="user-dropdown" style="position: relative; display: inline-block;">
            <button type="button" id="adminDropdownBtn" style="border: none; background: transparent; cursor: pointer; padding: 0; display: flex; align-items: center; outline: none;">
            ...
            <div class="user-dropdown-menu" id="adminDropdownMenu" style="display: none; position: absolute; top: 110%; right: 0; width: 220px; background: #ffffff; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.15); z-index: 9999; padding: 8px 0; border: 1px solid #eee; font-family: inherit;">
