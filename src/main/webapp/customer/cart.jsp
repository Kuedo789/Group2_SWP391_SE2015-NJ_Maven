...
<html>
<head>
    <title>Artisanal Bakehouse | Giỏ hàng</title>
            ...
            <div>
                <div class="cart-items-wrapper">
                    <c:forEach var="item" items="${cartItems}">
                        <div class="item-card ${item.isActive ? '' : 'disabled-item'}">
                            ...
                            <div class="item-controls">
                                <div class="qty-pill">
                                    <button type="submit" name="action" value="decrease-${item.cartItemId}" class="qty-btn" ${item.isActive ? '' : 'disabled'}>-</button>
                                    <input type="text" class="qty-input" value="${item.quantity}" readonly>
                                    <button type="submit" name="action" value="increase-${item.cartItemId}" class="qty-btn" ${item.isActive ? '' : 'disabled'}>+</button>
                                </div>
                            ...
                            <button type="submit" name="action" value="remove-${item.cartItemId}" class="remove-btn">
                                <c:choose>
                                    <c:when test="${item.isActive}">✕</c:when>
